                  ...
                  <div class="d-flex flex-wrap">
                     ...
                     <div class="widget-icon">
                        <div class="icon" data-color="#00eccf" style="color: rgb(0, 236, 207);"><i
                              class="micon dw dw-id-card1"></i></div>
                     </div>
                  </div>
               </div>
            </a>
            ...
            <a href="<?= Base_URL(); ?>/Clientes">
               <div class="card-box height-100-p widget-style3">
                  <div class="d-flex flex-wrap">
                     ...
                     <div class="widget-icon">
                        <div class="icon" data-color="#ff5b5b" style="color: rgb(255, 91, 91);"><span
                              class="micon dw dw-group"></span></div>
                     </div>
                  </div>
               </div>
            </a>
            ...
            <a href="<?= Base_URL(); ?>/Productos">
               <div class="card-box height-100-p widget-style3">
                  <div class="d-flex flex-wrap">
                     ...
                     <div class="widget-icon">
                        <div class="icon" data-color="#09cc06" style="color: rgb(9, 204, 6);"><i
                              class="micon dw dw-price-tag" aria-hidden="true"></i></div>
                     </div>
                  </div>
               </div>
            </a>
                  ...
                  <table class="table table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-center"><a href="<?= base_url() ?>/pedidos/orden/<?= $pedido['idpedido'] ?>"
                                 target="_blank"><i class="font-18 dw dw-eye"></i></a></td>
                        </tr>
                        <?php }
                           } ?>
                     </tbody>
         ...
         <div class="col-xl-5 mb-30">
            <div class="card-box height-100-p pd-20">
               <div class="contenedor">
                  ...
                  <div class="dflex">
                     <input class="form-control month-picker pagosMes" name="pagosMes" placeholder="Selecione un Mes"
                        type="text">
                     <button type="button" class="btn btn-primary" onClick="fntSearchPagos()"><i
                           class="font-18 dw dw-search1"></i></button>
                  </div>
               </div>
         ...
         <div class="col-xl-12 mb-30">
            <div class="card-box height-100-p pd-20">
               <div class="contenedor">
                  ...
                  <div class="dflex">
                     <input class="form-control month-picker ventasMes" name="ventasMes" placeholder="Selecione un Mes"
                        type="text">
                     <button type="button" class="btn btn-primary" onClick="fntSearchVentasMes()"><i
                           class="font-18 dw dw-search1"></i></button>
                  </div>
               </div>
               <div id="VentaMes">
         ...
         <div class="col-xl-12 mb-30">
            <div class="card-box height-100-p pd-20">
               <div class="contenedor">
                  ...
                  <div class="dflex">
                     <input class="form-control ventasAnio" name="ventasAnio" placeholder="Año" type="text"
                        minlength="4" maxlength="4" onkeypress="return controlTag(event);">
                     <button type="button" class="btn btn-primary btnVentasAnio" onClick="fntSearchVentasAnio()"><i
                           class="font-18 dw dw-search1"></i></button>
                  </div>
               </div>
