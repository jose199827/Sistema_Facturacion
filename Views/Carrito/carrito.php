						...
						<div class="row">
							<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
										...
										<table id="tblCarrito" class="table-shopping-cart">
											...
											?>
												<tr class="table_row <?= $idProducto; ?>">
													...
													<td class="column-2"><a href="<?= base_url() . '/Tienda/Producto/' . $producto['idproducto'] . '/' . $ruta; ?>" class="header-cart-item-name  hov-cl1 trans-04">
															<?= $producto['producto']; ?>
														</a></td>
			                  ...
			                  <div class="flex-w flex-m m-r-20 m-tb-5">
			                     <input class="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5" type="text" name="coupon" placeholder="Cupón">
							...
							<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
			                  ...
			                  <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
			                     <p class="stext-111 cl6 p-t-2">
			                        No hay métodos de envío disponibles. Por favor revisa tu dirección, o contáctanos si necesitas ayuda.
			                     </p>
			                     ...
			                     <div class="p-t-15">
									...
									<a href="<?= base_url() . '/Carrito/Procesarpago'; ?>" name="" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
										Procesar Pago
									</a>
								</div>
							</div>
