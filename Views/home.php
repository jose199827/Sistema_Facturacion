            ...
            <div class="item-slick1" style="background-image: url(<?= $arrSlider[$i]['portada']; ?>);">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="<?= $animateDescription; ?>"
                            data-delay="0">
                        ...
                        <div class="layer-slick1 animated visible-false" data-appear="<?= $animateName; ?>"
                            data-delay="800">
                        ...
                        <div class="layer-slick1 animated visible-false" data-appear="<?= $animateButton; ?>"
                            data-delay="1600">
...
<div class="sec-banner bg0 p-t-80 p-b-50">
    <div class="container">
      ...
      for ($i = 0; $i < count($arrBanner); $i++) {
        $ruta = $arrBanner[$i]['ruta'];
      ?>
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="<?= $arrBanner[$i]['portada']; ?>"
                        alt="<?= $arrBanner[$i]['nombre'] . " " . $arrBanner[$i]['descripcion']; ?>">

                    <a href="<?= base_url() . '/Tienda/Categoria/' . $arrBanner[$i]['idcategoria'] . '/' . $ruta; ?>"
