...
<head>
   ...
   $urlWeb = Base_URL();
   $urlImg = media() . "/tienda/images/blog-03.jpg";
   ...
   if (!empty($data['producto'])) {
      ...
      $urlImg = $data['producto']['images'][0]['url_img'];
   }
   ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ayuda y preguntas frecuentes</h5>
                ...
                <div class="modal-body">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum tempora magnam architecto vitae
                        libero, saepe est eaque ducimus qui placeat quas necessitatibus itaque, voluptas numquam
                        cupiditate
                        facere quidem iure in?
                        <br>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Alias necessitatibus debitis obcaecati
                        magnam consequuntur iure asperiores quisquam perferendis dignissimos, ex veritatis numquam ipsa
                        sequi
                        ab voluptatem eveniet, fuga laborum soluta. Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit.
                        Recusandae provident impedit neque sequi eius nemo quaerat repudiandae repellat sit? Hic omnis
                        eveniet
                        quia placeat harum totam! Quaerat exercitationem ipsa sint.
                    </p>
                </div>
                ...
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        <a href="#" class="flex-c-m trans-04 p-lr-25" data-toggle="modal"
                            data-target="#modalAyuda">Ayuda y
