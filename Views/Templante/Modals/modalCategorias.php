<!-- Apartado de modales -->
<!-- Modal de Roles -->
<div class="modal fade" id="categorias-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
   aria-hidden="true">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="formCategoria" name="formCategoria">
               ...
               <p class="text-primary">Los campos con asterisco (<span class="text-red-50">*</span>) son obligatorios.
               </p>
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label>Categoría: <span class="text-red-50">*</span> </label>
                        <input type="text" id="txtNombre" name="txtNombre" placeholder="Nombre de la Categoría"
                           class="form-control valid validText" required>
                     </div>
                     <div class="form-group">
                        <label>Descripción: <span class="text-red-50">*</span> </label>
                        <textarea name="txtDescripcion" id="txtDescripcion" rows="2"
                           placeholder="Descripción de de la Categoría" class="form-control valid validText"
                           required></textarea>
                     </div>
                     <div class="form-group">
...
<div class="modal fade" id="viewcategoria-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
   aria-hidden="true">
